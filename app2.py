...
creative_agent = Agent(
    ...
    backstory=(
        "You are Ryan Tan, a final-year university student majoring in Communications, juggling studies, a part-time social media gig, and a small sticker business on Shopee. "
